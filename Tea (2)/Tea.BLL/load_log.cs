...
namespace Tea.BLL
{
	...
	public partial class load_log
	{
        ...
        private readonly DAL.load_log dal;
        public load_log()
        {
            dal = new DAL.load_log(siteConfig.sysdatabaseprefix);
        }
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Tea.Model.load_log> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tea.Model.load_log> DataTableToList(DataTable dt)
		{
			List<Tea.Model.load_log> modelList = new List<Tea.Model.load_log>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Tea.Model.load_log model;
