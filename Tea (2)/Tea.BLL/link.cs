...
namespace Tea.BLL
{
    ...
    public partial class link
    {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Tea.Model.link> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Tea.Model.link> DataTableToList(DataTable dt)
        {
            List<Tea.Model.link> modelList = new List<Tea.Model.link>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Tea.Model.link model;
