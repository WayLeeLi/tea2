...
namespace Tea.BLL
{
	...
	public partial class feedback
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tea.Model.feedback> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tea.Model.feedback> DataTableToList(DataTable dt)
		{
			List<Tea.Model.feedback> modelList = new List<Tea.Model.feedback>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Tea.Model.feedback model;
