...
namespace Tea.BLL
{
    ...
    public partial class article_category
    {
        ...
        /// <param name="channel_name"></param>
        /// <returns></returns>
        public DataTable GetChildList(int parent_id, string channel_name, int site)
        {
            int channel_id = new BLL.channel().GetChannelId(channel_name);
            return dal.GetChildList(parent_id, channel_id, site);
        }
        /// <summary>
        /// 取得该频道下所有类别列表
        /// </summary>
        ...
        {
            return dal.GetList(parent_id, channel_id, company);
        }
        /// <summary>
        /// 取得该频道下所有类别列表
        /// </summary>
        ...
        /// <param name="channel_name">频道名称</param>
        /// <returns>DataTable</returns>
        public DataTable GetList(int parent_id, string channel_name, int site)
        {
            int channel_id = new BLL.channel().GetChannelId(channel_name);
            return dal.GetList(parent_id, channel_id, site);
        }
        #endregion
