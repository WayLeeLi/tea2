    ...
    public partial class orders
    {
        ...
        public int Add(Model.orders model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@invoice_title", SqlDbType.VarChar,1000),
                    ...
                    new SqlParameter("@zhe_code", SqlDbType.NVarChar,256),
                    new SqlParameter("@zhe_moeny", SqlDbType.NVarChar,128),
                    new SqlParameter("@zhe_else", SqlDbType.NVarChar,512),
                    new SqlParameter("@tuid", SqlDbType.Int,4),
                    new SqlParameter("@artid", SqlDbType.Int,4),
                    new SqlParameter("@chuid", SqlDbType.Int,4),
                    new SqlParameter("@num", SqlDbType.Int,4),
                    new SqlParameter("@zhe", SqlDbType.Decimal,5),
                    new SqlParameter("@user_add", SqlDbType.NVarChar,512),
                    new SqlParameter("@order_pay", SqlDbType.NVarChar,512),                    
                    new SqlParameter("@order_bao", SqlDbType.NVarChar,128),
                    new SqlParameter("@order_pay_code", SqlDbType.NVarChar,100)};
            ...
            parameters[34].Value = model.company;
            parameters[35].Value = model.zhe_code;
            parameters[36].Value = model.zhe_moeny;
            parameters[37].Value = model.zhe_else;
            parameters[38].Value = model.tuid;
            parameters[39].Value = model.artid;
            parameters[40].Value = model.chuid;
            parameters[41].Value = model.num;
            parameters[42].Value = model.zhe;
            parameters[43].Value = model.user_add;
            parameters[44].Value = model.order_pay;
            parameters[45].Value = model.order_bao;
            parameters[46].Value = model.order_pay_code;
            ...
            if (model.order_goods != null)
            {
                ...
                foreach (Model.order_goods modelt in model.order_goods)
                {
                    ...
                    strSql2.Append("article_id,order_id,goods_no,goods_title,img_url,spec_text,goods_price,real_price,quantity,point,company,goods_code,goodsid,goods_where,goods_img)");
                    ...
                    SqlParameter[] parameters2 = {
					        ...
					        new SqlParameter("@point", SqlDbType.Int,4),
                            new SqlParameter("@company", SqlDbType.Int,4),
                            new SqlParameter("@goods_code", SqlDbType.NVarChar,32),
                            new SqlParameter("@goodsid", SqlDbType.Int,4),
                            new SqlParameter("@goods_where", SqlDbType.NVarChar,256),
                            new SqlParameter("@goods_img", SqlDbType.NVarChar,256)};
                    ...
                    parameters2[10].Value = modelt.company;
                    parameters2[11].Value = modelt.goods_code;
                    parameters2[12].Value = modelt.goodsid;
                    parameters2[13].Value = modelt.goods_where;
                    parameters2[14].Value = modelt.goods_img;
                    cmd = new CommandInfo(strSql2.ToString(), parameters2);
                    sqllist.Add(cmd);

                    //扣减商品库存
                    strSql3 = new StringBuilder();
                    strSql3.Append("update " + databaseprefix + "goods set ");
                    strSql3.Append("stock_quantity=stock_quantity-@quantity where id=@article_id");
                    SqlParameter[] parameters3 = {
                            new SqlParameter("@quantity", SqlDbType.Int,4),
                            new SqlParameter("@article_id", SqlDbType.Int,4)};
                    parameters3[0].Value = modelt.quantity;
                    parameters3[1].Value = modelt.goodsid;
        ...
        public bool Update(Model.orders model)
        {
            ...
            strSql.Append("zhe_code=@zhe_code,");
            strSql.Append("zhe_moeny=@zhe_moeny,");
            strSql.Append("zhe_else=@zhe_else,");
            strSql.Append("user_add=@user_add,");
            strSql.Append("order_pay=@order_pay,");
            strSql.Append("order_bao=@order_bao,");
            strSql.Append("order_pay_code=@order_pay_code");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@order_no", SqlDbType.NVarChar,100),
					new SqlParameter("@trade_no", SqlDbType.NVarChar,100),
            ...
            parameters[31].Value = model.confirm_time;
            parameters[32].Value = model.complete_time;
            parameters[33].Value = model.zhe_code;
            parameters[34].Value = model.zhe_moeny;
            parameters[35].Value = model.zhe_else;
            parameters[36].Value = model.user_add;
            parameters[37].Value = model.order_pay;
            parameters[38].Value = model.order_bao;
            parameters[39].Value = model.order_pay_code;
        ...
        public Model.orders GetModelPayCode(string order_pay_code)
        {
            ...
            strSql.Append("select top 1 * ");
            strSql.Append(" from " + databaseprefix + "orders");
            strSql.Append(" where order_pay_code=@order_pay_code");
            SqlParameter[] parameters = {
					new SqlParameter("@order_pay_code", SqlDbType.NVarChar,100)};
            parameters[0].Value = order_pay_code;
        ...
        public Model.orders DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["zhe_code"] != null && row["zhe_code"].ToString() != "")
                {
                    model.zhe_code =row["zhe_code"].ToString();
                }
                if (row["zhe_moeny"] != null && row["zhe_moeny"].ToString() != "")
                {
                    model.zhe_moeny = row["zhe_moeny"].ToString();
                }
                if (row["zhe_else"] != null && row["zhe_else"].ToString() != "")
                {
                    model.zhe_else =row["zhe_else"].ToString();
                }
                if (row["order_amount"] != null && row["order_amount"].ToString() != "")
                {
                    model.order_amount = decimal.Parse(row["order_amount"].ToString());
                ...
                if (row["chuid"] != null && row["chuid"].ToString() != "")
                {
                    model.chuid = int.Parse(row["chuid"].ToString());
                }
                if (row["num"] != null && row["num"].ToString() != "")
                {
                    model.num = int.Parse(row["num"].ToString());
                }
                if (row["zhe"] != null && row["zhe"].ToString() != "")
                {
                    model.zhe = decimal.Parse(row["zhe"].ToString());
                }
                if (row["user_add"] != null && row["user_add"].ToString() != "")
                {
                    model.user_add =row["user_add"].ToString();
                }
                if (row["order_pay"] != null && row["order_pay"].ToString() != "")
                {
                    model.order_pay = row["order_pay"].ToString();
                }
                if (row["order_bao"] != null && row["order_bao"].ToString() != "")
                {
                    model.order_bao = row["order_bao"].ToString();
                }
                if (row["order_pay_code"] != null && row["order_pay_code"].ToString() != "")
                {
                    model.order_pay_code = row["order_pay_code"].ToString();
                }
                #endregion
                ...
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int n = 0; n < ds2.Tables[0].Rows.Count; n++)
                    {
                        ...
                        if (ds2.Tables[0].Rows[n]["goodsid"] != null && ds2.Tables[0].Rows[n]["goodsid"].ToString() != "")
                        {
                            modelt.goodsid = int.Parse(ds2.Tables[0].Rows[n]["goodsid"].ToString());
                        }
                        ls.Add(modelt);
                    }
