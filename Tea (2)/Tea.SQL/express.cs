...
namespace Tea.DAL
{
    ...
    public partial class express
    {
        ...
        public int Add(Model.express model)
        {
            ...
            strSql.Append("title,express_code,express_fee,website,remark,sort_id,is_lock,company,maxmoney)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@maxmoney", SqlDbType.Decimal,5)};
            ...
            parameters[8].Value = model.maxmoney;
        ...
        public bool Update(Model.express model)
        {
            ...
            parameters[5].Value = model.sort_id;
            parameters[6].Value = model.is_lock;
            parameters[7].Value = model.maxmoney;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,express_code,express_fee,website,remark,sort_id,is_lock,company,maxmoney");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,express_code,express_fee,website,remark,sort_id,is_lock,company");
            strSql.Append(" FROM " + databaseprefix + "express ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,express_code,express_fee,website,remark,sort_id,is_lock,company ");
            strSql.Append(" FROM " + databaseprefix + "express ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public Model.express DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["maxmoney"] != null && row["maxmoney"].ToString() != "")
                {
                    model.maxmoney = decimal.Parse(row["maxmoney"].ToString());
                }
            }
            return model;
        }
