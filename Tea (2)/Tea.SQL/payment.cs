...
namespace Tea.DAL
{
    ...
    public partial class payment
    {
        ...
        public int Add(Model.payment model)
        {
            ...
            strSql.Append("title,img_url,remark,type,poundage_type,poundage_amount,sort_id,is_lock,api_path,company)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,img_url,remark,type,poundage_type,poundage_amount,sort_id,is_lock,api_path,company");
