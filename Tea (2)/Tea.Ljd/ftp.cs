    ...
    public class FtpHelper
    {
        ...
        public static string GetFileStr(string fileName, string dir)
        {
            ...
            try
            {
                ...
                StreamReader reader = new StreamReader(ftpStream,System.Text.Encoding.GetEncoding("big5"));
            ...
            {
                return "获取ftp文件并读取内容失败：" + ex.Message;
            }
        }
        ...
        /// </summary>
        /// <param name="dirName">服务器下的相对路径</param>
        public static string DelDir(string dirName)
        {
            try
            {
                string uri = path + dirName;
