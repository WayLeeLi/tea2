...
namespace Tea.Model
{
    ...
    public partial class orders
    {
        ...
        private string _zhe_code = "";
        private string _zhe_moeny = "";
        private string _zhe_else = "";
        private string _order_pay = "";
        private string _order_bao = "";
        private string _order_pay_code = "";
        ...
        public string zhe_code
        {
            set { _zhe_code = value; }
            get { return _zhe_code; }
        }
        public string zhe_moeny
        {
            set { _zhe_moeny = value; }
            get { return _zhe_moeny; }
        }
        public string zhe_else
        {
            set { _zhe_else = value; }
            get { return _zhe_else; }
        }
        public string order_pay
        {
            set { _order_pay = value; }
            get { return _order_pay; }
        }
        public string order_bao
        {
            set { _order_bao = value; }
            get { return _order_bao; }
        }
        ...
        private int _artid = 0;
        public int artid
        {
            set { _artid = value; }
            get { return _artid; }
        }
        private int _chuid = 0;
        public int chuid
        {
            set { _chuid = value; }
            get { return _chuid; }
        ...
        {
            set { _user_add = value; }
            get { return _user_add; }
        }
         public string order_pay_code
        {
            set { _order_pay_code = value; }
            get { return _order_pay_code; }
        }
        #endregion Model
