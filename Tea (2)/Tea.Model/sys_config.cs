...
namespace Tea.Model
{
    ...
    public class siteconfig
    {
        ...
        private string _sysdatabaseprefix = "shop_";
        private string _sysdatabaseprefixuser = "art_";
        private string _sysdatabaseprefixspace = "space_";
        private string _sysdatabaseprefixji = "ji_";
        private string _sysdatabaseprefixnews = "news_";
        private string _sysdatabaseprefixweiweb = "weiweb_";
        private string _sysencryptstring = "UartU";
        ...
        /// 会员数据库表前缀
        /// </summary>
        public string sysdatabaseprefixuser
        {
            get { return _sysdatabaseprefixuser; }
            set { _sysdatabaseprefixuser = value; }
        }
        /// <summary>
        /// 空间数据库表前缀
        /// </summary>
        public string sysdatabaseprefixspace
        {
            get { return _sysdatabaseprefixspace; }
            set { _sysdatabaseprefixspace = value; }
        }
        /// <summary>
        /// 集数据库表前缀
        /// </summary>
        public string sysdatabaseprefixji
        {
            get { return _sysdatabaseprefixji; }
            set { _sysdatabaseprefixji = value; }
        }
        /// <summary>
        /// 新闻数据库表前缀
        /// </summary>
        public string sysdatabaseprefixnews
        {
            get { return _sysdatabaseprefixnews; }
            set { _sysdatabaseprefixnews = value; }
        }
        /// <summary>
        /// 微站数据库表前缀
        /// </summary>
        public string sysdatabaseprefixweiweb
        {
            get { return _sysdatabaseprefixweiweb; }
            set { _sysdatabaseprefixweiweb = value; }
        }
        /// <summary>
        /// 加密字符串
        /// </summary>
        ...
        private int _txt_Da = 0;
        private int _txt_Shen = 0;
        public int txt_Da
        {
            get { return _txt_Da; }
            set { _txt_Da = value; }
