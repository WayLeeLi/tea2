<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vorder.aspx.cs" Inherits="order" %>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <form id="order" method="post" action="vorder.aspx?cart=<%=cart%>"  onsubmit="javascript:return check();">
        ...
        <div class=" cart-bg">
            <div class="cart-box">
                ...
                <div class="cart-lrbox">
                    <dl>
                        <dd class="col_1">
                            <div class="c-pic float-l"><a href="<%#getpoint(Eval("by").ToString(),"show")%>.aspx?id=<%#Eval("id")%>"><img src="<%#Eval("img_url")%>" width="800" height="800" alt="<%#Eval("title")%>" /></a></div>
                        </dd>
                        <dd class="col_21">
                            <div class="pt-box  float-l">
                                <div class="cart-pt">
                                    <a href="<%#getpoint(Eval("by").ToString(),"show")%>.aspx?id=<%#Eval("id")%>"><strong><%#Eval("sub_title")%></strong></a></div>
                                <div class="cart-pt">
                                    <a href="<%#getpoint(Eval("by").ToString(),"show")%>.aspx?id=<%#Eval("id")%>"><%#Eval("title")%></a></div>
                            </div>
                        </dd>
                        <dd class="col_31">
                ...
                <asp:Repeater ID="data_gift" runat="server"><ItemTemplate>
                        <div class="cart-lrbox">
                            <dl>
                                ...
                                <dd class="col_2">
                                    <div class="pt-box  float-l">
                                        <div class="cart-pt"><strong><%#Eval("title")%></strong>
                                        </div>
                ...
                <div class="cart-tjbox">
                    <div class="cart-tjboxr">
                        ...
                        <dl style="display:none;">
                            <dd>
                                本次消費共得紅利</dd>
                            <dd class="price"><%=((cartModel.real_amount - cartModel.total_moneyback) / uconfig.money_pint).ToString("0.")%>點</dd>
                        </dl>
                        <%} %>
                    </div>
                </div>
