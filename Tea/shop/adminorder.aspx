<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminorder.aspx.cs" Inherits="order" %>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
//                    $("#txtsex_0").removeAttr("checked");
    ...
    <script language="javascript">
        function jisuan() {
            ...
            if ((real_amount + sy_yuan) < 0) {
                $("#zongji").html('0');
            }
            else {
                $("#zongji").html(real_amount + sy_yuan);
            }
        }
    </script>
        <script type="text/javascript">
            function get_hongli() {
                if ($("#cbhonglv").prop('checked') == true) {
                    $("#sy_honglv").text($('#ky_hongli').val());
                    jisuan();
                }
                else {
                    $("#sy_honglv").text('0');
...
<body>
    ...
    <form id="order" method="post" action="adminorder.aspx?uid=<%=uid%>"  onsubmit="javascript:return check();">
    ...
    <div class="width-sys">
        <div class=" cart-bg">
            <div class="order-box">
                <div class="order-boxw">
                    ...
                    <div class="order-box-form">
                        <div class="col-m5 float-l">
                            <dl>
                                <dt>訂購人姓名</dt><dd><input type="text" class="ipt-m1" name="txt_name" id="txt_name" value="<%=userModel.nick_name%>" />
                                    <label>
                            ...
                            <dl>
                                <dt>E-mail信箱</dt><dd><input type="text" name="txt_email" id="txt_email" class="ipt-m4" value="<%=userModel.email%>" /><em>*請填寫正確電子信箱，以便收到訂單資訊</em></dd>
                            </dl>
                        </div>
                        <div class="col-m5 float-l">
                            <dl>
              ...
              <option value="">請選擇縣市...</option>
             ...
             </select>     <%if (!string.IsNullOrEmpty(area)){%><script>                                                                    changeArea('<%=area%>', document.all.txt_city)</script><%}%>
                        ...
                        <%if (!string.IsNullOrEmpty(area)){%><script>                                                                 changeAreaSel(document.all.txt_state, '<%=area%>')</script><%}%>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <div class="select">
                                     <input name="txt_zip" id="txt_zip" type="text" class="ipt-m1"  value="<%=zip%>"  />(若無請填0)
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                <dt>詳細地址<em>*</em></dt>
                                <dd>
                                    <input type="text" name="txt_address" id="txt_address" class="ipt-m4" value="<%=userModel.address%>" />
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="order-box-form">
                        ...
                        <asp:Repeater ID="dataguo" runat="server"><ItemTemplate>
              ...
              <option value="">請選擇縣市...</option>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <div class="select">
                                        <input name="txtzip" id="txtzip" type="text" class="ipt-m1"   />(若無請填0)
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                <dt>詳細地址<em>*</em></dt>
                                <dd>
                                    <input type="text" name="txtaddress" id="txtaddress" class="ipt-m4" />
                                </dd>
                            </dl>
                        </div>
                    </div>
                ...
                <div class="order-boxw">
                    ...
                    <div class="order-box-form order-fukuan">
                        <asp:Repeater ID="data_pay" runat="server"><ItemTemplate>
                        <label id="la_<%#Eval("id")%>">
                            <ul>
                                <li class="col-n1"><input type="radio" id="pay_<%#Eval("id")%>" <%#Eval("id").ToString()=="1" ? " checked" : ""%> name="txt_pay"  value="<%#Eval("id")%>" /><%#Eval("title")%></li>
                                <li class="col-n5"></li>
                                <li class="col-n3"><%#Eval("remark")%></li>
                            </ul>
                        </label>
                        </ItemTemplate></asp:Repeater>
                    </div>
                ...
                <div class="order-boxw">
                    <div class="order-box-tit">發票</div>
                    <div id="Tabs1">
                        <ul>
                        ...
                        <div id="tabs-1"  style="display:none;"><input type="hidden" name="txtinvoice" id="txtinvoice" value="3" />
        ...
        <div class=" cart-bg">
            <div class="cart-box">
                ...
                <div class="cart-lrbox">
                    <dl>
                        <dd class="col_1">
                            <div class="c-pic float-l"><a href="show.aspx?id=<%#Eval("id")%>"><img src="<%#Eval("img_url")%>" width="800" height="800" alt="<%#Eval("title")%>" /></a></div>
                        </dd>
                        <dd class="col_21">
                            <div class="pt-box  float-l">
                                <div class="cart-pt">
                                    <a href="show.aspx?id=<%#Eval("id")%>"><strong><%#Eval("sub_title")%></strong></a></div>
                                <div class="cart-pt">
                                    <a href="show.aspx?id=<%#Eval("id")%>"><%#Eval("title")%></a></div>
                            </div>
                        </dd>
                        <dd class="col_31">
                     ...
                     <dd class="col_6">
                         <div class="price-box1"> <span class="wap-show" >小計：</span><span class="price">NT$<%#Tea.Common.Utils.StrToInt(Eval("quantity").ToString(), 0) * Tea.Common.Utils.StrToInt(Eval("user_price", "{0:0.}").ToString(), 0)%></span></div>
                ...
                <div class="cart-tjbox">
                    <div class="cart-tjboxl"  style="display:none;">
                    ...
                    <div class="cart-tjboxr">
                        <dl>
                            <dd>
                                合計</dd>
                            <dd class="priceh">NT$<span id="real_amount"><%=cartModel.real_amount.ToString("0.")%></span></dd>
                        </dl>
                        <dl  style="display:none;">
                            <dd>紅利點數兌商品</dd>
                            <dd class="priceh"><%=cartModel.total_point.ToString("0.")%>點</dd>
                        </dl>
                        <dl style="display:none;">
                            <dd>
                                折扣</dd>
                        ...
                        <dl>
                            ...
                            <dd class="priceh"><input type="hidden" id="yun" name="yun" />
                 ...
                 <%if (cartModel.real_amount > uconfig.pint_mane && uconfig.pint_money > 0)
                   { %>
                <div class="cart-tjbox" style="display:none;">
                    <div class="cart-tjboxl">
                        <p>
                            <label><input type="checkbox"  id="cbhonglv" name="cb_point" value="1" onclick="javascript:get_hongli();" />我要折抵<strong><%=userModel.point%>點</strong>紅利點數（購物滿$<%=uconfig.pint_money%>可使用紅利折抵，折抵上限為結帳金額50%）<input type="hidden" id="ky_hongli" value="<%=uconfig.pint_yong%>1" /></label>
                            <label>
                                <input type="checkbox" name="cbquan" id="cbquan" value="1" /> 使用優惠券<span class="col-n3"><input type="text" name="txt_quan" id="txt_zhe" onblur="javascript:get_code();" class="ipt-f1" placeholder="" /></span>
                            </label>
                        </p>
                    </div>
                    <div class="cart-tjboxr">
                        <dl>
                            <dd>紅利折扣</dd>
                            <dd class="price">$<span id="sy_honglv">0</span></dd>
                        </dl>
                        <dl>
                            <dd id="sy_quan_name">優惠券</dd>
                            <dd class="price">$<span id="sy_quan">0</span></dd>
                        </dl>
                    </div>
                </div>
                <%} %>
                <div class="cart-tjbox">
                    <div class="cart-tjboxr">
                        <dl>
                            <dd>總金額（含運費）</dd>
                            <dd class="priceh">NT$<span id="zongji"><%=(cartModel.real_amount + yun - cartModel.total_moneyback).ToString("0.")%></span></dd>
                        </dl>
                        <dl style="display:none;">
                            <dd>
                                本次消費共折抵紅利</dd>
                            <dd class="priceh"><span id="dikou_honglv"><%=cartModel.total_point%>點</dd>
                        </dl>
                         <%if(uconfig.money_pint>0){ %>
                        <dl style="display:none;">
                            <dd>
                                本次消費共得紅利</dd>
                            <dd class="price"><%=(cartModel.real_amount/uconfig.money_pint).ToString("0.")%>點</dd>
                        </dl>
                        <%} %>
                    </div>
                </div>
        ...
        <div class="order-btn"><a href="cart.aspx" class="cart-btn">上一步</a> <input type="submit" value="結帳" class="Collection-btn" />
        </div>
    </div>
    </form>
