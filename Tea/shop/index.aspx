        ...
        <div class="sub-right">
            <div class="sub-search">
                <div class="sub-search-sx">
                    <a href="index.aspx?tid=<%=tid%>&key=<%=key%>&sort=1">最新上架</a></div>
                <div class="sub-search-sx">
                    <a href="index.aspx?tid=<%=tid%>&key=<%=key%>&sort=2">熱門排行</a></div>
                <div class="sub-search-sx">
                    <a href="index.aspx?tid=<%=tid%>&key=<%=key%>&sort=3">價格由低至高</a></div>
                <div class="sub-search-sx">
                    <a href="index.aspx?tid=<%=tid%>&key=<%=key%>&sort=4">價格由高至低</a></div>
            </div>
