...
public partial class index : Tea.Web.UI.ShopPage
{
    ...
    protected string _sql = "(datediff(day,xia_date,getdate())<=0 or xia_date is null) and wheresql='point' and status=0 and datediff(minute,add_time,getdate())>=0", _orderby = "add_time desc,id desc", key, tname;
    protected int tid;
    protected int hid;
    protected int sort;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("list.aspx", "tid={0}&key={1}&sort={2}&page={3}", tid.ToString(), key.ToString(),sort.ToString(), "__id__");
