...
(function (e) {
    function s(a) {
        ...
        a.caption ? ("html" == b.options.captionType ? m = a.caption : "attr" == b.options.captionType && (m = e("<div class='cloudzoom-caption'>" + a.caption + "</div>")), m.css("display", "block"), h.css({
            width: k
        }), l.append(h), h.append(m), e("#detail-p").append(l), this.r = m.outerHeight(), "bottom" == b.options.captionPosition ? h.css("top", 0) : (h.css("top", 0), this.za = this.r)) : e("body").append(l);
        l.css({
            opacity: 0,
            width: k,
            height: f + this.r
