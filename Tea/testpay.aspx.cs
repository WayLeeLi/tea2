...
public partial class testpay : Tea.Web.UI.ShopPage
{
    Tea.BLL.orders bll = new Tea.BLL.orders();
    protected int id,pid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (id > 0 && pid>0)
        {
            ...
            modelpay = new Tea.BLL.payment().GetModel(pid);
            ...
            if (ptype == "WeiXinpay")
            {
                sbHtml.Append("<form id='paysubmit' name='ecbanksubmit' action='https://payment-stage.opay.tw/Cashier/AioCheckOut/V5' method='post'>");
            }
            else
            {
                sbHtml.Append("<form id='paysubmit' name='ecbanksubmit' action='https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V5' method='post'>");
            }
            ...
            sbHtml.Append("<input type='Submit'></form>");// style='display:none;'
