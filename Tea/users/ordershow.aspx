<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ordershow.aspx.cs" Inherits="ordershow" %>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <table width="100%" border="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <%=new Tea.BLL.payment().GetTitle(model.payment_id)%>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%=getinvoice(model.is_invoice.ToString())%>&nbsp;&nbsp;<%if(model.invoice_taxes==1){ %>(發票已經寄出)<%} %>
                                                </td>
                                            </tr>
                    ...
                    <div class="cart-box">
                            ...
                            <dl>
                                <dd class="col_11">
                                    <div class="c-pic float-l">
                                        <a href="/shop/<%#getpoint(Eval("goods_where").ToString(),"show")%>.aspx?id=<%#Eval("article_id")%>">
                                            <img src="<%#Eval("goods_img")%>" width="800" height="800" alt="<%#Eval("goods_title")%>" /></a></div>
                                </dd>
                                <dd class="col_21">
                                    <div class="pt-box  float-l">
                                        <div class="cart-pt">
                                            <a href="/shop/<%#getpoint(Eval("goods_where").ToString(),"show")%>.aspx?id=<%#Eval("article_id")%>"><strong><%#get_sub(Eval("article_id").ToString())%></strong></a></div>
                                        <div class="cart-pt">
                                            <a href="/shop/<%#getpoint(Eval("goods_where").ToString(),"show")%>.aspx?id=<%#Eval("article_id")%>"><%#Eval("goods_title")%></a></div>
                                    </div>
                                </dd>
                                <dd class="col_31">
                        ...
                        <div class="cart-lrbox">
                            <dl>
                                ...
                                <dd class="col_21">
                                    <div class="pt-box  float-l">
                                        <div class="cart-pt"><strong><%#Eval("article_list")%></strong></div>
                        ...
                        <div class="cart-tjboxr">
                            <dl>
                                <dd>
                                    合計</dd>
                                <dd class="priceh">
                                    NT$<%=model.real_amount.ToString("0.")%></dd>
                            </dl>
                            <dl>
                                <dd>
                                    紅利點數兌商品</dd>
                            ...
                            <dl>
                                <dd>
                                    運費（<%=getpeisong(getuseradd(model.user_add, 5))%>）</dd>
                                <dd class="priceh">
                                    NT$<%=model.express_fee.ToString("0.")%></dd>
                            </dl>
                        </div>
                    </div>
                    <div class="cart-tjbox">
                        <div class="cart-tjboxr">
                            ...
                            <dl>
                                <dd>優惠券</dd>
                                <dd class="price">
                                    $<%=model.payment_fee.ToString("0.")%></dd>
                            </dl>
                        </div>
                    </div>
                    <div class="cart-tjbox">
                        <div class="cart-tjboxr">
                            <dl>
                                <dd>總金額（含運費）</dd>
                                <dd class="priceh">
                                    NT$<%=model.order_amount.ToString("0.")%></dd>
                            </dl>
                            <dl>
                                <dd>本次消費共折抵紅利</dd>
                                <dd class="priceh">
                                    <%=model.company+model.point%>點</dd>
                            </dl>
                            <dl>
                                <dd>
                                    本次消費共得紅利</dd>
