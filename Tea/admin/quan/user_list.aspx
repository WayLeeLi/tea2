<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_list.aspx.cs" Inherits="Tea.Web.admin.goods.sales_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="user_zhe.aspx?action=<%=TWEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="user_zhe.aspx?action=<%#TWEnums.ActionEnum.Edit%>&id=<%#Eval("quan_id")%>"><%#Eval("quan_title")%></a></td>
