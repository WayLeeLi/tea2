...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="8%">選擇</th>
    <th align="left">標題</th>
    <th align="left" width="12%">所屬類別</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="edit.aspx?action=<%#TWEnums.ActionEnum.Edit%>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&url=page|<%=page%>-category_id|<%=category_id%>"><%#Eval("title")%></a>(<a href="/help.aspx?id=<%#Eval("id")%>" target="_blank">預覽</a>)</td>
    <td><%#new Tea.BLL.basic().get_basic("help", Eval("category_id").ToString())%></td>
