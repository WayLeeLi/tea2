    ...
    public partial class list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("basic_where='qu'" + CombSqlTxt(this.keywords), "basic_id asc");
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Edit.ToString(), "修改分區設定排序:"); //記錄日誌
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Audit.ToString(), "審核分區設定"); //記錄日誌
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Delete.ToString(), "刪除分區設定成功" + sucCount + "條，失敗" + errorCount + "條"); //記錄日誌
