    ...
    public partial class manager_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Model.manager model = GetAdminInfo(); //取得當前管理員資料
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //ChkAdminLevel("manager_list", TWEnums.ActionEnum.Delete.ToString()); //檢查許可權
            int sucCount = 0;
            int errorCount = 0;
            BLL.manager bll = new BLL.manager();
            ...
            AddAdminLog(TWEnums.ActionEnum.Delete.ToString(), "刪除管理員" + sucCount + "條，失敗" + errorCount + "條"); //記錄日誌
            JscriptMsg("刪除成功" + sucCount + "條，失敗" + errorCount + "條！", Utils.CombUrlTxt("manager_list.aspx", "keywords={0}", this.keywords));
        }
    }
}
