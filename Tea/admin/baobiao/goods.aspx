<%@ Page Language="C#" AutoEventWireup="true" CodeFile="goods.aspx.cs" Inherits="Tea.Web.admin.order.order_list" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th align="center">商品編號</th>
    <th align="left">商品名稱</th>
    <th align="left">銷售規格</th>
    <th align="center">銷售數量</th>
    <th align="left">銷售金額</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    <td align="center"><%#Eval("goods_no").ToString()%></td>
    <td><%#Eval("title")%></td>
    <td><%#Eval("color").ToString()%></td>
    <td align="center"><%#Eval("shulian").ToString()%></td>
    <td>$<%#Eval("jine").ToString()%></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
