...
namespace Tea.Web.admin.basic
{
    public partial class list : Web.UI.ManagePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Edit.ToString(), "修改問題類型排序:"); //記錄日誌
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Audit.ToString(), "審核問題類型"); //記錄日誌
        ...
        {
            ChkAdminLevelEdit("channel_content", "Edit");
            ...
            AddAdminLog(TWEnums.ActionEnum.Delete.ToString(), "刪除問題類型成功" + sucCount + "條，失敗" + errorCount + "條"); //記錄日誌
