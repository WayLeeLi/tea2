    ...
    public partial class list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("basic_where='city'" + CombSqlTxt(this.keywords), "basic_id asc");
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Edit.ToString(), "修改國家設定排序:"); //記錄日誌
            JscriptMsg("儲存排序成功！", Utils.CombUrlTxt("list.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(TWEnums.ActionEnum.Audit.ToString(), "審核國家設定"); //記錄日誌
        ...
        {
            ChkAdminLevelEdit("basiccity", "Edit");
            ...
            AddAdminLog(TWEnums.ActionEnum.Delete.ToString(), "刪除國家設定成功" + sucCount + "條，失敗" + errorCount + "條"); //記錄日誌
