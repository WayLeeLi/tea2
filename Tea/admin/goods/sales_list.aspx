<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sales_list.aspx.cs" Inherits="Tea.Web.admin.goods.sales_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
        <li><a class="add" href="sales_edit.aspx?action=<%=TWEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th width="6%">編號</th>
    <th align="left">名稱</th>
    <th align="left" width="12%">模式</th>
    <th align="left" width="12%">開始時間</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="sales_edit.aspx?action=<%#TWEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    <td>滿件折扣</td>
    ...
    <td align="center"><a href="sales_edit.aspx?action=<%#TWEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
