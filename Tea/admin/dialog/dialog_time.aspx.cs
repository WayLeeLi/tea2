...
namespace Tea.Web.admin.dialog
{
    public partial class dialog_group : Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dialog_time.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&goods_ids={4}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("dialog_time.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&property={3}", this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.goods_ids));
        }
    }
}