...
namespace Tea.Web.admin.dialog
{
    public partial class dialog_group : Web.UI.ManagePage
    {
        ...
        private void RptBind(int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("dialog_group_price.aspx", "channel_id={0}&category_id={1}&keywords={2}&page={3}&goods_ids={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dialog_group_price.aspx", "channel_id={0}&category_id={1}&keywords={2}&goods_ids={3}",
