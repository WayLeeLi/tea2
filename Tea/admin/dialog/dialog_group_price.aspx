<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dialog_group_price.aspx.cs" Inherits="Tea.Web.admin.dialog.dialog_group" %>
...
<script type="text/javascript">
    ...
    function execGroupHtml() {
        ...
        $(".checkall :checked").each(function (i) {
            ...
            trhtml += "<td><input class=\"input small groupprice\" name=\"new_price\" discount='" + original_price + "'  onkeyup=\"value=value.replace(\/[^\\d.]\/g,'')\" value=\"" + original_price + "\"></td>";
