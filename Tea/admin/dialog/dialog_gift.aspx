<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dialog_gift.aspx.cs" Inherits="Tea.Web.admin.dialog.dialog_group" %>
...
<script type="text/javascript">
    ...
    function execGroupHtml() {
        ...
        $(".checkall :checked").each(function (i) {
            ...
            trhtml += "<td><input class=\"input small\" name=\"new_price\" onkeyup=\"value=value.replace(\/[^\\d.]\/g,'')\" value=\"" + original_price + "\"></td>";
