    ...
    public partial class dialog_group : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind(this.channel_id, this.category_id, "id not in(" + goods_ids + ") and brand_id in(1,2,3,5)" + CombSqlTxt(this.keywords, this.category_id), "id desc");
            }
        }
        ...
        private void RptBind(int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("dialog_quan_goods.aspx", "channel_id={0}&category_id={1}&keywords={2}&page={3}&goods_ids={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dialog_quan_goods.aspx", "channel_id={0}&category_id={1}&keywords={2}&goods_ids={3}",
