    ...
    public partial class list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (status<0)
                {
                    RptBind(this.channel_id, this.category_id, "wheresql='jiajia'" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                }
                else
                {
                    ...
                    if (status != 2)
                    {
                        RptBind(this.channel_id, this.category_id, "wheresql='jiajia' and status=" + status + "" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                    }
                    else
                    {
                        RptBind(this.channel_id, this.category_id, "wheresql='jiajia' and status=0 and (datediff(day,xia_date,getdate())<=0 or xia_date is null) and datediff(minute,add_time,getdate())>=0" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                    }
                }
            }
        }
        ...
        private void RptBind(int _channel_id, int _category_id, string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}&page={5}&status={6}", _channel_id.ToString(), _category_id.ToString(), this.keywords, this.property, this.brand_id.ToString(), "__id__", status.ToString());
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}&sort={5}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}&status={5}",
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}&brand_id={5}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("儲存成功！", Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.brand_id.ToString()));
        }
        ...
        protected void btnAudit_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批次審核成功！", Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.brand_id.ToString()));
        }
        ...
        {
            ChkAdminLevelEdit("product_tuan", "Edit");
            ...
            JscriptMsg("刪除成功" + sucCount + "條，失敗" + errorCount + "條！", Utils.CombUrlTxt("jiajia_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.brand_id.ToString()));
        }
