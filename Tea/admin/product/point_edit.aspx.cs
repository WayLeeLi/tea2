    ...
    public partial class edit : Web.UI.ManagePage
    {
        ...
        private bool DoAdd()
        {
            ...
            if (aid > 0)
            {
                ...
                modelgoods.chang = Utils.StrToInt(txtChang.Text, 0);
                modelgoods.kuan = Utils.StrToInt(txtKuan.Text, 0);
                modelgoods.gao = Utils.StrToInt(txtGao.Text, 0);
                modelgoods.zhong = Utils.StrToInt(txtZhong.Text, 0);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == TWEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改資料成功！", "point_list.aspx?channel_id=" + this.channel_id + "&" + url.Replace("|", "=").Replace("-", "&"));
            }
            else //添加
            {
                ChkAdminLevelEdit("goods_proint", "Edit");
                ...
                JscriptMsg("添加資料成功！", "point_list.aspx?channel_id=" + this.channel_id);
            }
        }
