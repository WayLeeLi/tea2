    ...
    public partial class list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (status<0)
                {
                    RptBind(this.channel_id, this.category_id, "wheresql='tuan'" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                }
                else
                {
                    ...
                    if (status != 2)
                    {
                        RptBind(this.channel_id, this.category_id, "wheresql='tuan' and status=" + status + "" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                    }
                    else
                    {
                        RptBind(this.channel_id, this.category_id, "wheresql='tuan' and status=0 and (datediff(day,xia_date,getdate())<=0 or xia_date is null) and datediff(minute,add_time,getdate())>=0" + CombSqlTxt(this.keywords, this.property, this.brand_id, this.category_id), "sort_id desc,add_time desc,id desc");
                    }
                }
            }
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}&sort={5}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}&status={5}",
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}&brand_id={5}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("儲存成功！", Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.brand_id.ToString()));
        }
        ...
        protected void btnAudit_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批次審核成功！", Utils.CombUrlTxt("tuan_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&brand_id={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.brand_id.ToString()));
        }
