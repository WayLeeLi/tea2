<%@ Page Language="C#" AutoEventWireup="true"  Debug="true"  CodeFile="point_edit.aspx.cs" Inherits="Tea.Web.admin.product.edit" ValidateRequest="false" %>
...
<!--巡覽列-->
<div class="location">
  <a href="point_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表頁</span></a>
  ...
  <dl style="display:none;">
    ...
    <dd>
      <div class="rule-single-select">
        ...
        <asp:ListItem Text="積分購"  Value="6"></asp:ListItem>
        </asp:DropDownList>
      </div>
    </dd>
  </dl>
