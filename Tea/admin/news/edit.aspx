...
<div class="tab-content">
  ...
  <dl style="display:none;">
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlFabu" runat="server"  sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        ...
        <asp:ListItem Value="0" Selected="True">上架</asp:ListItem>
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*標題最多50個字元</span>
    </dd>
  </dl>
  <dl>
    <dt>封面圖片</dt>
