...
namespace Tea.Web.admin.about
{
    public partial class article_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel_id = TWRequest.GetQueryInt("channel_id",3);
        ...
        {
            ddlCategoryId.DataSource = new Tea.BLL.basic().GetList(0, "basic_where='news'", "basic_sort");
        ...
        {
            ChkAdminLevelEdit("site_news", "Edit");
