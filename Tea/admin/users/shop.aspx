<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shop.aspx.cs" Inherits="Tea.Web.admin.shop.ku" %>
...
<script type="text/javascript">
    ...
    function showGroupDialog() {
        ...
        var groupDialog = top.dialog({
            ...
            padding: 0,
            title: "選擇商品",
            url: 'dialog/dialog_group_price.aspx?channel_id=7&goods_ids=' + goods_ids,
            onclose: function () {
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected">批次會員折扣</a></li>
      </ul>
    </div>
  </div>
</div>
 ...
 <dl>
    ...
    <dd>
      <table border="0" cellspacing="0" cellpadding="0" class="border-table">
        ...
        <tr>
          <td>
              <input name="goods_group_id" type="hidden" value="<%#Eval("pid")%>" />
          ...
          <td><input class="input small groupprice" name="new_price" onkeyup="value=value.replace(/[^\d.]/g,'')" discount='<%#Eval("sell_price") %>' value="<%#Eval("price","{0:0.}")%>" /></td>
  ...
  <dl>
    <dt>折扣</dt>
    <dd><asp:TextBox id="txtAmount" runat="server" CssClass="input small" datatype="n" sucmsg=" "></asp:TextBox>%</dd>
  </dl>
</div>
<!--/內容-->
